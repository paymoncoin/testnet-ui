...
export type PaymonMinter$Data = {
    $$type: 'PaymonMinter$Data';
    totalSupply: bigint;
    owner: Address;
    jettonContent: Cell;
    mintable: boolean;
...
export function storePaymonMinter$Data(src: PaymonMinter$Data) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeCoins(src.totalSupply);
        b_0.storeAddress(src.owner);
...
export function loadPaymonMinter$Data(slice: Slice) {
    const sc_0 = slice;
    const _totalSupply = sc_0.loadCoins();
    const _owner = sc_0.loadAddress();
    const _jettonContent = sc_0.loadRef();
    const _mintable = sc_0.loadBit();
    return { $$type: 'PaymonMinter$Data' as const, totalSupply: _totalSupply, owner: _owner, jettonContent: _jettonContent, mintable: _mintable };
}

export function loadTuplePaymonMinter$Data(source: TupleReader) {
    const _totalSupply = source.readBigNumber();
    const _owner = source.readAddress();
    const _jettonContent = source.readCell();
    const _mintable = source.readBoolean();
...
export function loadGetterTuplePaymonMinter$Data(source: TupleReader) {
    const _totalSupply = source.readBigNumber();
    const _owner = source.readAddress();
    const _jettonContent = source.readCell();
    const _mintable = source.readBoolean();
...
export function storeTuplePaymonMinter$Data(source: PaymonMinter$Data) {
    const builder = new TupleBuilder();
    builder.writeNumber(source.totalSupply);
    builder.writeAddress(source.owner);
    builder.writeCell(source.jettonContent);
...
export function dictValueParserPaymonMinter$Data(): DictionaryValue<PaymonMinter$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storePaymonMinter$Data(src)).endCell());
        },
        parse: (src) => {
            return loadPaymonMinter$Data(src.loadRef().beginParse());
        }
    }
}
...
export function storeDexData(src: DexData) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.usdtWalletAddress);
        b_0.storeAddress(src.owner);
        b_0.storeAddress(src.manager);
        b_0.storeCoins(src.usdtBalance);
        b_0.storeBit(src.stopped);
        const b_1 = new Builder();
        b_1.storeCoins(src.lockedUsdt);
        b_1.storeAddress(src.paymonMinterAddress);
        b_1.storeCoins(src.taxRate);
        b_1.storeCoins(src.priceInUsdt);
        b_1.storeCoins(src.availableUsdt);
        b_0.storeRef(b_1.endCell());
    };
}

export function loadDexData(slice: Slice) {
    const sc_0 = slice;
    const _usdtWalletAddress = sc_0.loadAddress();
    const _owner = sc_0.loadAddress();
    const _manager = sc_0.loadAddress();
    const _usdtBalance = sc_0.loadCoins();
    const _stopped = sc_0.loadBit();
    const sc_1 = sc_0.loadRef().beginParse();
    const _lockedUsdt = sc_1.loadCoins();
    const _paymonMinterAddress = sc_1.loadAddress();
    const _taxRate = sc_1.loadCoins();
    const _priceInUsdt = sc_1.loadCoins();
    const _availableUsdt = sc_1.loadCoins();
    return { $$type: 'DexData' as const, usdtWalletAddress: _usdtWalletAddress, owner: _owner, manager: _manager, usdtBalance: _usdtBalance, stopped: _stopped, lockedUsdt: _lockedUsdt, paymonMinterAddress: _paymonMinterAddress, taxRate: _taxRate, priceInUsdt: _priceInUsdt, availableUsdt: _availableUsdt };
}

export function loadTupleDexData(source: TupleReader) {
    const _usdtWalletAddress = source.readAddress();
    const _owner = source.readAddress();
    const _manager = source.readAddress();
    const _usdtBalance = source.readBigNumber();
    const _stopped = source.readBoolean();
    const _lockedUsdt = source.readBigNumber();
    const _paymonMinterAddress = source.readAddress();
    const _taxRate = source.readBigNumber();
    const _priceInUsdt = source.readBigNumber();
    const _availableUsdt = source.readBigNumber();
    return { $$type: 'DexData' as const, usdtWalletAddress: _usdtWalletAddress, owner: _owner, manager: _manager, usdtBalance: _usdtBalance, stopped: _stopped, lockedUsdt: _lockedUsdt, paymonMinterAddress: _paymonMinterAddress, taxRate: _taxRate, priceInUsdt: _priceInUsdt, availableUsdt: _availableUsdt };
}

export function loadGetterTupleDexData(source: TupleReader) {
    const _usdtWalletAddress = source.readAddress();
    const _owner = source.readAddress();
    const _manager = source.readAddress();
    const _usdtBalance = source.readBigNumber();
...
export function storeTupleDexData(source: DexData) {
    const builder = new TupleBuilder();
    builder.writeAddress(source.usdtWalletAddress);
    builder.writeAddress(source.owner);
    builder.writeAddress(source.manager);
    builder.writeNumber(source.usdtBalance);
    builder.writeBoolean(source.stopped);
    builder.writeNumber(source.lockedUsdt);
    builder.writeAddress(source.paymonMinterAddress);
    builder.writeNumber(source.taxRate);
    builder.writeNumber(source.priceInUsdt);
    builder.writeNumber(source.availableUsdt);
    return builder.build();
}

export function dictValueParserDexData(): DictionaryValue<DexData> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeDexData(src)).endCell());
        },
        parse: (src) => {
            return loadDexData(src.loadRef().beginParse());
        }
    }
}

export type Dex$Data = {
    $$type: 'Dex$Data';
    queryId: bigint;
    usdtWalletAddress: Address;
    owner: Address;
...
export function storeDex$Data(src: Dex$Data) {
    return (builder: Builder) => {
        const b_0 = builder;
        ...
        b_1.storeCoins(src.usdtBalance);
        b_1.storeBit(src.stopped);
        b_1.storeCoins(src.lockedUsdt);
        b_1.storeAddress(src.paymonMinterAddress);
        b_1.storeCoins(src.taxRate);
        const b_2 = new Builder();
        b_2.storeCoins(src.priceInUsdt);
        b_1.storeRef(b_2.endCell());
        b_0.storeRef(b_1.endCell());
    };
}

export function loadDex$Data(slice: Slice) {
    const sc_0 = slice;
    ...
    const _usdtBalance = sc_1.loadCoins();
    const _stopped = sc_1.loadBit();
    const _lockedUsdt = sc_1.loadCoins();
    const _paymonMinterAddress = sc_1.loadAddress();
    const _taxRate = sc_1.loadCoins();
    const sc_2 = sc_1.loadRef().beginParse();
    const _priceInUsdt = sc_2.loadCoins();
    return { $$type: 'Dex$Data' as const, queryId: _queryId, usdtWalletAddress: _usdtWalletAddress, owner: _owner, manager: _manager, usdtBalance: _usdtBalance, stopped: _stopped, lockedUsdt: _lockedUsdt, paymonMinterAddress: _paymonMinterAddress, taxRate: _taxRate, priceInUsdt: _priceInUsdt };
}

export function loadTupleDex$Data(source: TupleReader) {
    const _queryId = source.readBigNumber();
    const _usdtWalletAddress = source.readAddress();
    const _owner = source.readAddress();
    const _manager = source.readAddress();
...
export function loadGetterTupleDex$Data(source: TupleReader) {
    const _queryId = source.readBigNumber();
    const _usdtWalletAddress = source.readAddress();
    const _owner = source.readAddress();
    const _manager = source.readAddress();
...
export function storeTupleDex$Data(source: Dex$Data) {
    const builder = new TupleBuilder();
    builder.writeNumber(source.queryId);
    builder.writeAddress(source.usdtWalletAddress);
    builder.writeAddress(source.owner);
...
export function dictValueParserDex$Data(): DictionaryValue<Dex$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeDex$Data(src)).endCell());
        },
        parse: (src) => {
            return loadDex$Data(src.loadRef().beginParse());
        }
    }
}
...
function initDex_init_args(src: Dex_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeInt(src.queryId, 257);
        b_0.storeAddress(src.owner);
        b_0.storeInt(src.priceInUsdt, 257);
        b_0.storeCoins(src.taxRate);
        b_0.storeRef(src.paymonContent);
    };
}

async function Dex_init(queryId: bigint, owner: Address, priceInUsdt: bigint, taxRate: bigint, paymonContent: Cell) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initDex_init_args({ $$type: 'Dex_init_args', queryId, owner, priceInUsdt, taxRate, paymonContent })(builder);
...
export const Dex_errors = {
    ...
    1318: { message: "Incorrect manager" },
    2366: { message: "Incorrect balance after send" },
    2875: { message: "Unauthorized burn source" },
    8194: { message: "Incorrect owner" },
    9215: { message: "Incorrect sender" },
    10363: { message: "Unauthorized burn" },
    20930: { message: "Internal accounting error" },
    28262: { message: "Overdraw" },
    ...
    59720: { message: "Invalid action" },
} as const

export const Dex_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
const Dex_types: ABIType[] = [
    ...
    {"name":"PaymonMinter$Data","header":null,"fields":[{"name":"totalSupply","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"jettonContent","type":{"kind":"simple","type":"cell","optional":false}},{"name":"mintable","type":{"kind":"simple","type":"bool","optional":false}}]},
    ...
    {"name":"DexData","header":null,"fields":[{"name":"usdtWalletAddress","type":{"kind":"simple","type":"address","optional":false}},{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"manager","type":{"kind":"simple","type":"address","optional":false}},{"name":"usdtBalance","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"stopped","type":{"kind":"simple","type":"bool","optional":false}},{"name":"lockedUsdt","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"paymonMinterAddress","type":{"kind":"simple","type":"address","optional":false}},{"name":"taxRate","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"priceInUsdt","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"availableUsdt","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}}]},
    {"name":"Dex$Data","header":null,"fields":[{"name":"queryId","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"usdtWalletAddress","type":{"kind":"simple","type":"address","optional":false}},{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"manager","type":{"kind":"simple","type":"address","optional":false}},{"name":"usdtBalance","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"stopped","type":{"kind":"simple","type":"bool","optional":false}},{"name":"lockedUsdt","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"paymonMinterAddress","type":{"kind":"simple","type":"address","optional":false}},{"name":"taxRate","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"priceInUsdt","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}}]},
]
...
const Dex_getters: ABIGetter[] = [
    {"name":"dexData","methodId":115010,"arguments":[],"returnType":{"kind":"simple","type":"DexData","optional":false}},
    {"name":"stopped","methodId":74107,"arguments":[],"returnType":{"kind":"simple","type":"bool","optional":false}},
]

export const Dex_getterMapping: { [key: string]: string } = {
    'dexData': 'getDexData',
    'stopped': 'getStopped',
}

const Dex_receivers: ABIReceiver[] = [
...
export const JETTON_DECIMALS = 1000000000n;
export const FORWARD_OPS = 5n;

export class Dex implements Contract {
    
    public static readonly storageReserve = 0n;
    public static readonly errors = Dex_errors_backward;
    public static readonly opcodes = Dex_opcodes;
    
    static async init(queryId: bigint, owner: Address, priceInUsdt: bigint, taxRate: bigint, paymonContent: Cell) {
        return await Dex_init(queryId, owner, priceInUsdt, taxRate, paymonContent);
    }
    
    static async fromInit(queryId: bigint, owner: Address, priceInUsdt: bigint, taxRate: bigint, paymonContent: Cell) {
        const __gen_init = await Dex_init(queryId, owner, priceInUsdt, taxRate, paymonContent);
        const address = contractAddress(0, __gen_init);
        return new Dex(address, __gen_init);
    }
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: JettonUpdateContent | JettonNotification | JettonBurnNotification) {
    ...
    async getDexData(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get('dexData', builder.build())).stack;
        const result = loadGetterTupleDexData(source);
        return result;
    }
