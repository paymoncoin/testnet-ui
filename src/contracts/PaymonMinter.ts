...
export type UpdateUsdtPrice = {
    $$type: 'UpdateUsdtPrice';
    newPrice: bigint;
}

export function storeUpdateUsdtPrice(src: UpdateUsdtPrice) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeUint(1343302095, 32);
        b_0.storeCoins(src.newPrice);
    };
}

export function loadUpdateUsdtPrice(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 1343302095) { throw Error('Invalid prefix'); }
    const _newPrice = sc_0.loadCoins();
    return { $$type: 'UpdateUsdtPrice' as const, newPrice: _newPrice };
}

export function loadTupleUpdateUsdtPrice(source: TupleReader) {
    const _newPrice = source.readBigNumber();
    return { $$type: 'UpdateUsdtPrice' as const, newPrice: _newPrice };
}

export function loadGetterTupleUpdateUsdtPrice(source: TupleReader) {
    const _newPrice = source.readBigNumber();
    return { $$type: 'UpdateUsdtPrice' as const, newPrice: _newPrice };
}

export function storeTupleUpdateUsdtPrice(source: UpdateUsdtPrice) {
    const builder = new TupleBuilder();
    builder.writeNumber(source.newPrice);
    return builder.build();
}

export function dictValueParserUpdateUsdtPrice(): DictionaryValue<UpdateUsdtPrice> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeUpdateUsdtPrice(src)).endCell());
        },
        parse: (src) => {
            return loadUpdateUsdtPrice(src.loadRef().beginParse());
        }
    }
}
...
export function storeChangeManager(src: ChangeManager) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeUint(721549916, 32);
        b_0.storeAddress(src.newManager);
    };
}

export function loadChangeManager(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 721549916) { throw Error('Invalid prefix'); }
    const _newManager = sc_0.loadAddress();
    return { $$type: 'ChangeManager' as const, newManager: _newManager };
}

export function loadTupleChangeManager(source: TupleReader) {
    const _newManager = source.readAddress();
    return { $$type: 'ChangeManager' as const, newManager: _newManager };
}

export function loadGetterTupleChangeManager(source: TupleReader) {
    const _newManager = source.readAddress();
    return { $$type: 'ChangeManager' as const, newManager: _newManager };
}

export function storeTupleChangeManager(source: ChangeManager) {
    const builder = new TupleBuilder();
    builder.writeAddress(source.newManager);
    return builder.build();
}

export function dictValueParserChangeManager(): DictionaryValue<ChangeManager> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeChangeManager(src)).endCell());
        },
        parse: (src) => {
            return loadChangeManager(src.loadRef().beginParse());
        }
    }
}
...
export function storeUpdateTaxRate(src: UpdateTaxRate) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeUint(3482817042, 32);
        b_0.storeCoins(src.newTaxRate);
    };
}

export function loadUpdateTaxRate(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 3482817042) { throw Error('Invalid prefix'); }
    const _newTaxRate = sc_0.loadCoins();
    return { $$type: 'UpdateTaxRate' as const, newTaxRate: _newTaxRate };
}

export function loadTupleUpdateTaxRate(source: TupleReader) {
    const _newTaxRate = source.readBigNumber();
    return { $$type: 'UpdateTaxRate' as const, newTaxRate: _newTaxRate };
}

export function loadGetterTupleUpdateTaxRate(source: TupleReader) {
    const _newTaxRate = source.readBigNumber();
    return { $$type: 'UpdateTaxRate' as const, newTaxRate: _newTaxRate };
}

export function storeTupleUpdateTaxRate(source: UpdateTaxRate) {
    const builder = new TupleBuilder();
    builder.writeNumber(source.newTaxRate);
    return builder.build();
}

export function dictValueParserUpdateTaxRate(): DictionaryValue<UpdateTaxRate> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeUpdateTaxRate(src)).endCell());
        },
        parse: (src) => {
            return loadUpdateTaxRate(src.loadRef().beginParse());
        }
    }
}

export type SetUsdtWallet = {
    $$type: 'SetUsdtWallet';
    usdtWalletAddress: Address;
}

export function storeSetUsdtWallet(src: SetUsdtWallet) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeUint(1545750994, 32);
        b_0.storeAddress(src.usdtWalletAddress);
    };
}

export function loadSetUsdtWallet(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 1545750994) { throw Error('Invalid prefix'); }
    const _usdtWalletAddress = sc_0.loadAddress();
    return { $$type: 'SetUsdtWallet' as const, usdtWalletAddress: _usdtWalletAddress };
}

export function loadTupleSetUsdtWallet(source: TupleReader) {
    const _usdtWalletAddress = source.readAddress();
    return { $$type: 'SetUsdtWallet' as const, usdtWalletAddress: _usdtWalletAddress };
}

export function loadGetterTupleSetUsdtWallet(source: TupleReader) {
    const _usdtWalletAddress = source.readAddress();
    return { $$type: 'SetUsdtWallet' as const, usdtWalletAddress: _usdtWalletAddress };
}

export function storeTupleSetUsdtWallet(source: SetUsdtWallet) {
    const builder = new TupleBuilder();
    builder.writeAddress(source.usdtWalletAddress);
    return builder.build();
}

export function dictValueParserSetUsdtWallet(): DictionaryValue<SetUsdtWallet> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeSetUsdtWallet(src)).endCell());
        },
        parse: (src) => {
            return loadSetUsdtWallet(src.loadRef().beginParse());
        }
    }
}

export type RevokeOwnership = {
    $$type: 'RevokeOwnership';
    queryId: bigint;
}

export function storeRevokeOwnership(src: RevokeOwnership) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeUint(3765562218, 32);
        b_0.storeUint(src.queryId, 64);
    };
}

export function loadRevokeOwnership(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 3765562218) { throw Error('Invalid prefix'); }
    const _queryId = sc_0.loadUintBig(64);
    return { $$type: 'RevokeOwnership' as const, queryId: _queryId };
}

export function loadTupleRevokeOwnership(source: TupleReader) {
    const _queryId = source.readBigNumber();
    return { $$type: 'RevokeOwnership' as const, queryId: _queryId };
}

export function loadGetterTupleRevokeOwnership(source: TupleReader) {
    const _queryId = source.readBigNumber();
    return { $$type: 'RevokeOwnership' as const, queryId: _queryId };
}

export function storeTupleRevokeOwnership(source: RevokeOwnership) {
    const builder = new TupleBuilder();
    builder.writeNumber(source.queryId);
    return builder.build();
}

export function dictValueParserRevokeOwnership(): DictionaryValue<RevokeOwnership> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeRevokeOwnership(src)).endCell());
        },
        parse: (src) => {
            return loadRevokeOwnership(src.loadRef().beginParse());
        }
    }
}

export type ClaimAccumulatedTax = {
    $$type: 'ClaimAccumulatedTax';
    queryId: bigint;
    amount: bigint;
    to: Address;
}

export function storeClaimAccumulatedTax(src: ClaimAccumulatedTax) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeUint(519054377, 32);
        b_0.storeUint(src.queryId, 64);
        b_0.storeCoins(src.amount);
        b_0.storeAddress(src.to);
    };
...
export function loadClaimAccumulatedTax(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 519054377) { throw Error('Invalid prefix'); }
    const _queryId = sc_0.loadUintBig(64);
    const _amount = sc_0.loadCoins();
    const _to = sc_0.loadAddress();
    return { $$type: 'ClaimAccumulatedTax' as const, queryId: _queryId, amount: _amount, to: _to };
}

export function loadTupleClaimAccumulatedTax(source: TupleReader) {
    const _queryId = source.readBigNumber();
    const _amount = source.readBigNumber();
    const _to = source.readAddress();
    return { $$type: 'ClaimAccumulatedTax' as const, queryId: _queryId, amount: _amount, to: _to };
...
export function loadGetterTupleClaimAccumulatedTax(source: TupleReader) {
    const _queryId = source.readBigNumber();
    const _amount = source.readBigNumber();
    const _to = source.readAddress();
    return { $$type: 'ClaimAccumulatedTax' as const, queryId: _queryId, amount: _amount, to: _to };
...
export function storeTupleClaimAccumulatedTax(source: ClaimAccumulatedTax) {
    const builder = new TupleBuilder();
    builder.writeNumber(source.queryId);
    builder.writeNumber(source.amount);
    builder.writeAddress(source.to);
...
export function dictValueParserClaimAccumulatedTax(): DictionaryValue<ClaimAccumulatedTax> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeClaimAccumulatedTax(src)).endCell());
        },
        parse: (src) => {
            return loadClaimAccumulatedTax(src.loadRef().beginParse());
        }
    }
}
...
function initPaymonMinter_init_args(src: PaymonMinter_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeCoins(src.totalSupply);
        b_0.storeAddress(src.owner);
...
async function PaymonMinter_init(totalSupply: bigint, owner: Address, jettonContent: Cell, mintable: boolean) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    initPaymonMinter_init_args({ $$type: 'PaymonMinter_init_args', totalSupply, owner, jettonContent, mintable })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

export const PaymonMinter_errors = {
...
export const PaymonMinter_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
const PaymonMinter_types: ABIType[] = [
    ...
    {"name":"UpdateUsdtPrice","header":1343302095,"fields":[{"name":"newPrice","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}}]},
    {"name":"ChangeManager","header":721549916,"fields":[{"name":"newManager","type":{"kind":"simple","type":"address","optional":false}}]},
    {"name":"UpdateTaxRate","header":3482817042,"fields":[{"name":"newTaxRate","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}}]},
    {"name":"SetUsdtWallet","header":1545750994,"fields":[{"name":"usdtWalletAddress","type":{"kind":"simple","type":"address","optional":false}}]},
    {"name":"RevokeOwnership","header":3765562218,"fields":[{"name":"queryId","type":{"kind":"simple","type":"uint","optional":false,"format":64}}]},
    {"name":"ClaimAccumulatedTax","header":519054377,"fields":[{"name":"queryId","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"to","type":{"kind":"simple","type":"address","optional":false}}]},
...
const PaymonMinter_opcodes = {
    ...
    "ClaimTON": 60010958,
    "UpdateUsdtPrice": 1343302095,
    "ChangeManager": 721549916,
    "UpdateTaxRate": 3482817042,
    "SetUsdtWallet": 1545750994,
    "RevokeOwnership": 3765562218,
    "ClaimAccumulatedTax": 519054377,
}

const PaymonMinter_getters: ABIGetter[] = [
...
export const PaymonMinter_getterMapping: { [key: string]: string } = {
    'get_jetton_data': 'getGetJettonData',
    'get_wallet_address': 'getGetWalletAddress',
}

const PaymonMinter_receivers: ABIReceiver[] = [
...
export class PaymonMinter implements Contract {
    
    public static readonly storageReserve = 0n;
    public static readonly errors = PaymonMinter_errors_backward;
    public static readonly opcodes = PaymonMinter_opcodes;
    
    static async init(totalSupply: bigint, owner: Address, jettonContent: Cell, mintable: boolean) {
        return await PaymonMinter_init(totalSupply, owner, jettonContent, mintable);
    }
    
    static async fromInit(totalSupply: bigint, owner: Address, jettonContent: Cell, mintable: boolean) {
        const __gen_init = await PaymonMinter_init(totalSupply, owner, jettonContent, mintable);
        const address = contractAddress(0, __gen_init);
        return new PaymonMinter(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new PaymonMinter(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  PaymonMinter_types,
        getters: PaymonMinter_getters,
        receivers: PaymonMinter_receivers,
        errors: PaymonMinter_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: Mint | null | ProvideWalletAddress | JettonBurnNotification | JettonUpdateContent | ChangeOwner | CloseMinting | ClaimTON) {
